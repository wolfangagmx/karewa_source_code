...
organizationSchema = mongoose.Schema({
    ...
    description: {
        type: String,
        default: "Aquí podras obtener información sobre los procedimientos de contrataciones públicas, incluyendo la compra, renta y contratación de servicios que se realizan  "
    },
    contactLocation: {
        type: String,
        default: ""
